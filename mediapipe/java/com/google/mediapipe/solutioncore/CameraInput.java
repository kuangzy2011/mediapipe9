...
public class CameraInput {
  ...
  private boolean enableFlip = false;
  ...
  public void setEnableFlip(boolean flip) {
    enableFlip = flip;
  }
  /**
  ...
  public void start(
      Activity activity, EGLContext eglContext, CameraFacing cameraFacing, int width, int height, @Nonnull ImageCapture.Builder imageCaptureBuilder) {
    ...
    if (converter == null) {
      ...
      //[CTOUCH]
      //Log.d(TAG, "[AAAAA] 1- begin to flip camera " + enableFlip);
      if(enableFlip && cameraFacing == CameraFacing.BACK) {
        //Log.d(TAG, "[AAAAA] 2- begin to flip camera " + enableFlip);
